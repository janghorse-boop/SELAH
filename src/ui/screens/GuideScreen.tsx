    ...
    <div className="rounded-xl border border-neutral-200 p-4">
      ...
      <div className="relative mt-1.5 h-7 overflow-hidden rounded bg-neutral-100">
        {s.zones.map((z) => (
          <div
            ...
            style={{ left: `${logPos(z.from)}%`, width: `${logPos(z.to) - logPos(z.from)}%` }}
          >
            {z.label}
          </div>
        ))}
      ...
      {s.howlBands ? (
        ...
        <>
          ...
          <div className="mt-1.5 rounded-lg border-l-[3px] border-green-600 bg-green-50 px-3 py-2">
            <div className="text-[11px] leading-relaxed text-neutral-700">{s.howlNote}</div>
            <ul className="mt-1 list-inside list-disc text-[11px] text-neutral-700">
